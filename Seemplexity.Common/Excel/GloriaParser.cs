...
// Type: Seemplexity.Common.Excel.GloriaParser
...
{
  public class GloriaParser : ITransferParser
  {
    private readonly Func<RowNoHeader, IDictionary<string, int>, TouristTransferRow> _rowCreator = (Func<RowNoHeader, IDictionary<string, int>, TouristTransferRow>) ((r, rows) => new TouristTransferRow()
    {
    ...
    public ExcelTransferModel Parse(string fileName)
    {
      ...
      excelTransferModel.Type = PartnerType.Gloria;
